...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        \DB::statement("ALTER TABLE dictaminators_response_form3_5 MODIFY obs3_5_1 VARCHAR(255) DEFAULT 'sin comentarios' NOT NULL");
        \DB::statement("ALTER TABLE dictaminators_response_form3_5 MODIFY obs3_5_2 VARCHAR(255) DEFAULT 'sin comentarios' NOT NULL");
    }
