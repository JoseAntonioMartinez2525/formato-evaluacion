...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        \DB::statement("ALTER TABLE dictaminators_response_form3_10 MODIFY obsGrupal VARCHAR(255) DEFAULT 'sin comentarios' NOT NULL");
        \DB::statement("ALTER TABLE dictaminators_response_form3_10 MODIFY obsIndividual VARCHAR(255) DEFAULT 'sin comentarios' NOT NULL");
