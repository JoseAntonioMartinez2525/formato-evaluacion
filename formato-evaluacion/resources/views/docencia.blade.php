                            ...
                            <form id="form3_4" method="POST" onsubmit="event.preventDefault(); submitForm('/store34', 'form3_4');">
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <td><input type=" value" id="comNacional" placeholder="0"
                                                    oninput="onActv3Comision3_4()">
                                                </td>
                ...
                async function submitForm(url, formId) {
                    ...
                    switch (formId) {
                        ...
                        case 'form3_4':
                            ...
                            formData['score3_4'] = score3_4Label.innerText;
                            formData['comision3_4'] = comision3_4Label.innerText;
