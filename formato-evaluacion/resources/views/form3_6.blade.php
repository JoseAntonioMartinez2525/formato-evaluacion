                        ...
                        if (dictaminadorId) {
                            try {
                                ...
                                if (data.form3_6) {
                                    ...
                                    document.getElementById('comision3_6').textContent = data.form3_6.comision3_6 || '0';
                                    document.querySelector('span[name="comisionDict3_6"]').textContent = data.form3_6.comisionDict3_6 || '0';
                                    document.querySelector('span[name="obs3_6_1"]').textContent = data.form3_6.obs3_6_1 || '';
