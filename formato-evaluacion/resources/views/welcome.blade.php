...
<body class="font-sans antialiased">
        ...
        <main class="container">
          ...
          <table class="table table-sm">
            ...
            <tr>
              ...
              <td><button type="button" onclick="submitForm('form2')" class="btn btn-primary">Enviar</button></td>
            </tr>
            </tbody>
          </table>
          </form>
  ...
  <script>
    ...
    document.querySelector('input[name="horasActv2"]').addEventListener('input', function () {
      let horasActv2 = parseFloat(this.value);
      ...
      puntajeEvaluarElement.innerText = puntajeEvaluar;
    });
