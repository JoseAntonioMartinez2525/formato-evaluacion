...
<body class="font-sans antialiased">
  <div class="bg-gray-50 text-black/50">
    <div class="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <form id="form2_2" method="POST" action="{{ route('store') }}">
      <div>
      ...
      <td for=""></td>
      <td id="hours" for=""><label for="">0</label></td>
      <td id="actv2Comision" for=""><label for="">0</label></td>
      </tr>
      <tr>
      ...
      <tr>
      <td>a) <label for="">&nbsp</label><label for="">&nbsp</label><label for="">&nbsp</label><label
      ...
      <tr>
      <td>b)
      <label for="">&nbsp</label><label for="">&nbsp</label><label for="">&nbsp</label><label
      for="">&nbsp</label><label for="">&nbsp</label><label for="">&nbsp</label><label
      for="">&nbsp</label><label for="">&nbsp</label>
      <label style="height:84px; width: 170px;">Plan de estudios de una carrera o posgrado
      nuevo
      o actualización</label>
      <label style="height:84px; width: 180px;">Colaboración en la Comisión para la
      elaboración
      del documento</label>
      <label for=""></label>
      <label for=""></label>
      ...
      <td class="elabInput"><input id="elaboracion2" type="text" oninput="onActv3Subtotal()"
      placeholder="0"></td>
      <td><label id="elaboracionSubTotal2" for="" type="text"></label></td>
      ...
      nuevo
      o actualización</label>
      <label style="height:84px; width: 180px;">Elaboración de contenidos mínimos</label>
      <label for=""></label>
      <label for=""></label>
      <label for=""></label>
      <label for=""></label>
      ...
      <td class="elabInput"><input id="elaboracion3" type="text" oninput="onActv3Subtotal()"
      placeholder="0"></td>
      <td><label id="elaboracionSubTotal3" for="" type="text"></label></td>
      ...
      nuevo
      o actualización</label>
      <label style="height:84px; width: 180px;">Elaboración de programas de
      asignatura</label>
      <label for=""></label>
      <label for=""></label>
      <label for=""></label>
      ...
      <td class="elabInput"><input id="elaboracion4" type="text" oninput="onActv3Subtotal()"
      placeholder="0"></td>
      <td><label id="elaboracionSubTotal4" for="" type="text"></label></td>
      ...
      nuevo
      o actualización</label>
      <label style="height:84px; width: 180px;">Actualización de programas de
      asignatura</label>
      <label for=""></label>
      <label for=""></label>
      <label for=""></label>
      ...
      <td class="elabInput"><input id="elaboracion5" type="text" oninput="onActv3Subtotal()"
      placeholder="0"></td>
      <td><label id="elaboracionSubTotal5" for="" type="text"></label></td>
      ...
      <thead>
      <tr>
      <td style="height: 80px; width: 200px;">3.2 Calidad del desempeño docente evaluada por el alumnado
      </td>
      <td>Puntaje</td>
      ...
      <td class="elabInput"><input id="r1" type="value" placeholder="0" oninput="onActv3Puntaje()"></td>
      <td id="cant1">0</td>
      <td><input id="prom90_100" type="value" placeholder="0" oninput="onActv3_2Comision()"></td>
      ...
      <td class="elabInput"><input id="r2" type="value" placeholder="0" oninput="onActv3Puntaje()"></td>
      <td id="cant2">0</td>
      <td><input id="prom80_90" placeholder="0" type="value" oninput="onActv3_2Comision()"></td>
      ...
      <td class="elabInput"><input id="r3" type="value" placeholder="0" oninput="onActv3Puntaje()"></td>
      <td id="cant3">0</td>
      <td><input id="prom70_80" placeholder="0" type="value" oninput="onActv3_2Comision()"></td>
      ...
      <td class="elabInput"><input id="rc1" type="text" placeholder="0" oninput="onActv3SubTotal3()">
      </td>
      <td id="stotal1"></td>
      ...
      <td class="elabInput"><input id="rc2" type="text" placeholder="0" oninput="onActv3SubTotal3()">
      </td>
      <td id="stotal2"></td>
      ...
      <td class="elabInput"><input id="rc3" type="text" placeholder="0" oninput="onActv3SubTotal3()">
      </td>
      <td id="stotal3"></td>
      ...
      <tr>
      <td>d)</td>
      <td>1. Traducción de libro, 2.Traducción de material de apoyo didáctico, 3. Traducciones
      publicadas de artículos.</td>
      <td>Autor(a)</td>
      <td id="p25">
      <center><b>25</b></center>
      </td>
      <td class="elabInput"><input id="rc4" type="text" placeholder="0" oninput="onActv3SubTotal3()">
      </td>
      <td id="stotal4"></td>
      ...
      <thead>
      <tr>
      <th colspan=2 class="punto3_4" scope=col style="padding:30px;">3.4 Distinciones académicas
      ...
      <td id="p20"><b>20</b></td>
      <td><input type="value" id="cantidadRegional" placeholder="0" oninput="onActv3SubTotal3_4()">
      </td>
      <td id="cantidadRegional2"></td>
      <td><input type="value" id="comRegional" placeholder="0" oninput="onActv3Comision3_4()"></td>
      ...
      <td>Preparación de grupos de alumnado para olimpiadas competencias académicas o exámenes
      generales.</td>
      ...
      <thead>
      <tr>
      <th colspan=2 class="punto3_5" scope=col style="padding:30px;">3.5 Asistencia, puntualidad y
      permanencia en el desempeño docente, evaluada por el JD y por CAAC </th>
      ...
      <td id="p35"><b>35</b></td>
      <td><input type="value" id="cantDA" placeholder="0" oninput="onActv3SubTotal3_5()"></td>
      <td id="cantDA2"></td>
      <td><input type="value" id="comDA" placeholder="0" oninput="onActv3Comision3_5()"></td>
      ...
      <thead>
      <tr>
      <th colspan=1 class="punto3_7" scope=col style="padding:30px;">3.7 Cursos de actualización
      ...
      <thead>
      <tr>
      <th colspan=1 class="punto3_8" scope=col style="padding:30px;">3.8 Impartición de cursos,
      diplomados, seminarios, talleres extracurriculares, de educación, continua o de formación y
      ...
      <th class="descripcion"><b>*JD,CAAC, DDCE, DDIE, SA,DIIP, según corresponda. Cuando sea en
      instituciones externas, presentar constancia de la institución y el convenio acuerdo con
      la
      UABCS.</b> </th>
      </tr>
      </thead>
      ...
      <thead>
      <tr>
      <th scope="col" class="p3_9" colspan=9>3.9 Trabajos dirigidos para la titulación de estudiantes
      </th>
      </tr>
      <tr>
      <th class="table-ajust" scope="col"></th>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_1" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias1">0</td>
      <td><input type="value" id="tutoriasComision1" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_2" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias2">0</td>
      <td><input type="value" id="tutoriasComision2" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_3" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias3">0</td>
      <td><input type="value" id="tutoriasComision3" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_4" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias4">0</td>
      <td><input type="value" id="tutoriasComision4" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_5" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias5">0</td>
      <td><input type="value" id="tutoriasComision5" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_6" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias6">0</td>
      <td><input type="value" id="tutoriasComision6" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_7" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias7">0</td>
      <td><input type="value" id="tutoriasComision7" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_8" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias8">0</td>
      <td><input type="value" id="tutoriasComision8" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_9" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias9">0</td>
      <td><input type="value" id="tutoriasComision9" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_10" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias10">0</td>
      <td><input type="value" id="tutoriasComision10" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_11" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias11">0</td>
      <td><input type="value" id="tutoriasComision11" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_12" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias12">0</td>
      <td><input type="value" id="tutoriasComision12" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_13" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias13">0</td>
      <td><input type="value" id="tutoriasComision13" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_14" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias14">0</td>
      <td><input type="value" id="tutoriasComision14" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_15" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias15">0</td>
      <td><input type="value" id="tutoriasComision15" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_16" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias16">0</td>
      <td><input type="value" id="tutoriasComision16" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="puntaje3_9_17" oninput="onActv3SubTotal3_9()"></td>
      <td id="tutorias17">0</td>
      <td><input type="value" id="tutoriasComision17" placeholder="0" oninput="onActv3Comision3_9()">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=2>3.10 Tutorías a estudiantes</th>
      <th class="acreditacion">Puntaje</th>
      <th class="acreditacion">cantidad</th>
      <th></th>
      <th></th>
      ...
      <td><input type="value" id="comisionGrupal" oninput="onActv3Comision3_10()" placeholder="0">
      </td>
      ...
      <td><input type="value" id="individualCant" oninput="onActv3SubTotal3_10()" placeholder="0">
      </td>
      <td></td>
      <td></td>
      <td></td>
      ...
      <td><input type="value" id="comisionIndividual" oninput="onActv3Comision3_10()" placeholder="0">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=5>3.11 Asesoría a estudiantes</th>
      <th></th>
      <th></th>
      <th></th>
      ...
      <td><input type="value" placeholder="0" id="cantAsesoria" oninput="onActv3SubTotal3_11()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalAsesoria"></td>
      <td><input type="value" id="comisionAsesoria" placeholder="0" oninput="onActv3Comision3_11()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantServicio" oninput="onActv3SubTotal3_11()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalServicio"></td>
      <td><input type="value" id="comisionServicio" placeholder="0" oninput="onActv3Comision3_11()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantPracticas" oninput="onActv3SubTotal3_11()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalPracticas"></td>
      <td><input type="value" id="comisionPracticas" placeholder="0" oninput="onActv3Comision3_11()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantCientifico" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalCientificos"></td>
      <td><input type="value" id="comisionCientificos" placeholder="0" oninput="onActv3Comision3_12()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantDivulgacion" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalDivulgacion"></td>
      <td><input type="value" id="comisionDivulgacion" placeholder="0" oninput="onActv3Comision3_12()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantTraduccion" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalTraduccion"></td>
      <td><input type="value" id="comisionTraduccion" placeholder="0" oninput="onActv3Comision3_12()">
      </td>
      ...
      <td><input type="value" id="comisionArbitrajeInt" placeholder="0" oninput="onActv3Comision3_12()">
      </td>
      ...
      <td><input type="value" id="comisionArbitrajeNac" placeholder="0" oninput="onActv3Comision3_12()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantSinInt" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalSinInt"></td>
      <td><input type="value" id="comisionSinInt" placeholder="0" oninput="onActv3Comision3_12()"></td>
      ...
      <td><input type="value" placeholder="0" id="cantSinNac" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalSinNac"></td>
      <td><input type="value" id="comisionSinNac" placeholder="0" oninput="onActv3Comision3_12()"></td>
      ...
      <td><input type="value" placeholder="0" id="cantAutor" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalAutor"></td>
      <td><input type="value" id="comisionAutor" placeholder="0" oninput="onActv3Comision3_12()"></td>
      ...
      <td><input type="value" placeholder="0" id="cantEditor" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalEditor"></td>
      <td><input type="value" id="comisionEditor" placeholder="0" oninput="onActv3Comision3_12()"></td>
      ...
      <td><input type="value" placeholder="0" id="cantWeb" oninput="onActv3SubTotal3_12()"></td>
      <td></td>
      <td></td>
      <td id="subtotalWeb"></td>
      <td><input type="value" id="comisionWeb" placeholder="0" oninput="onActv3Comision3_12()"></td>
      ...
      <tr>
      <th class="acreditacion" colspan=7>3.13 Proyectos académicos de investigación</th>
      ...
      <td><input type="value" placeholder="0" id="cantInicioFinanExt" oninput="onActv3SubTotal3_13()">
      </td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalInicioFinanExt"></td>
      <td><input type="value" id="comisionInicioFinancimientoExt" placeholder="0" oninput="onActv3Comision3_13()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantInicioInvInterno" oninput="onActv3SubTotal3_13()">
      </td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalInicioInvInterno"></td>
      <td><input type="value" id="comisionInicioInvInterno" placeholder="0" oninput="onActv3Comision3_13()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantReporteFinanciamExt" oninput="onActv3SubTotal3_13()">
      </td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalReporteFinanciamExt"></td>
      <td><input type="value" id="comisionReporteFinanciamExt" placeholder="0" oninput="onActv3Comision3_13()">
      </td>
      ...
      <td><input type="value" id="comisionReporteInvInt" placeholder="0" oninput="onActv3Comision3_13()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantCongresoInt" oninput="onActv3SubTotal3_14()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalCongresoInt">0</td>
      <td><input type="value" id="comisionCongresoInt" placeholder="0" oninput="onActv3Comision3_14()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantCongresoNac" oninput="onActv3SubTotal3_14()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalCongresoNac">0</td>
      <td><input type="value" id="comisionCongresoNac" placeholder="0" oninput="onActv3Comision3_14()">
      </td>
      ...
      <td><input type="value" placeholder="0" id="cantCongresoLoc" oninput="onActv3SubTotal3_14()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalCongresoLoc">0</td>
      <td><input type="value" id="comisionCongresoLoc" placeholder="0" oninput="onActv3Comision3_14()">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=2>3.15 Registro de patentes y productos de investigación
      tecnológica
      y educativa</th>
      <th class="acreditacion">Puntaje</th>
      <th class="acreditacion">Cantidad</th>
      ...
      <td><input type="value" id="cantPatentes" placeholder="0" oninput="onActv3SubTotal3_15()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalPatentes">0</td>
      <td><input type="value" id="comisionPatententes" placeholder="0" oninput="onActv3Comision3_15()">
      </td>
      ...
      <td><input type="value" id="cantPrototipos" placeholder="0" oninput="onActv3SubTotal3_15()"></td>
      <td></td>
      <td></td>
      <td></td>
      <td id="subtotalPrototipos">0</td>
      <td><input type="value" id="comisionPrototipos" placeholder="0" oninput="onActv3Comision3_15()">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=7> 3.16 Actividades de arbitraje, revisión, correción y edición
      </th>
      ...
      <td><input type="value" id="cantArbInt" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalArbInt"></td>
      <td><input type="value" id="comisionArbInt" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantArbNac" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalArbNac"></td>
      <td><input type="value" id="comisionArbNac" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantPubInt" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalPubInt"></td>
      <td><input type="value" id="comisionPubInt" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantPubNac" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalPubNac"></td>
      <td><input type="value" id="comisionPubNac" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantRevInt" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalRevInt"></td>
      <td><input type="value" id="comisionRevInt" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantRevNac" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalRevNac"></td>
      <td><input type="value" id="comisionRevNac" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <td><input type="value" id="cantRevista" placehoolder="0" oninput="onActv3SubTotal3_16()"></td>
      <td></td>
      <td></td>
      <td id="subtotalRevista"></td>
      <td><input type="value" id="comisionRevista" placeholder="0" oninput="onActv3Comision3_16()"></td>
      ...
      <th class="descripcion"><b>Institución que lo solicita. En el caso de la UABCS, DIIP, SG, CA,
      JD.</b>
      </th>
      </tr>
      </thead>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=3> 3.17 Proyectos académicos de extensión y difusión</th>
      <th class="acreditacion">Puntaje</th>
      <th class="acreditacion">Cantidad</th>
      <th></th>
      ...
      <tr>
      <td>c)</td>
      <td>Reporte cumplido del periodo anual de proyecto de extensión y difusión con financiamiento
      externo
      </td>
      <td></td>
      <td id="puntajeRepDifusionExt"><b>35</b></td>
      <td><input type="value" id="cantRepDifusionExt" placehoolder="0" oninput="onActv3SubTotal3_17()">
      </td>
      <td></td>
      <td id="subtotalRepDifusionExt"></td>
      <td><input type="value" id="comisionRepDifusionExt" placeholder="0" oninput="onActv3Comision3_17()">
      </td>
      <td><input class="table-header" type="text" id="obsRepDifusionExt"></td>
      </tr>
      <tr>
      <td>d)</td>
      <td>Reporte cumplido del periodo anual de proyecto de extensión y difusión internos, aprobados por
      CAAC</td>
      <td></td>
      <td id="puntajeRepDifusionInt"><b>20</b></td>
      <td><input type="value" id="cantRepDifusionInt" placehoolder="0" oninput="onActv3SubTotal3_17()">
      </td>
      <td></td>
      <td id="subtotalRepDifusionInt"></td>
      <td><input type="value" id="comisionRepDifusionInt" placeholder="0" oninput="onActv3Comision3_17()">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=5> 3.18 Organización de congresos o eventos institucionales del
      área
      ...
      <td><input type="value" id="cantCicloComOrgInt" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComOrgInt"></td>
      <td><input type="value" id="comisionCicloComOrgInt" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <td><input type="value" id="cantCicloComOrgNac" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComOrgNac"></td>
      <td><input type="value" id="comisionCicloComOrgNac" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <td><input type="value" id="cantCicloComOrgReg" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComOrgReg"></td>
      <td><input type="value" id="comisionCicloComOrgReg" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <td><input type="value" id="cantCicloComApoyoInt" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComApoyoInt"></td>
      <td><input type="value" id="comisionCicloComApoyoInt" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <td><input type="value" id="cantCicloComApoyoNac" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComApoyoNac"></td>
      <td><input type="value" id="comisionCicloComApoyoNac" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <td><input type="value" id="cantCicloComApoyoReg" placehoolder="0" oninput="onActv3SubTotal3_18()">
      </td>
      <td></td>
      <td id="subtotalCicloComApoyoReg"></td>
      <td><input type="value" id="comisionCicloComApoyoReg" placeholder="0" oninput="onActv3Comision3_18()">
      </td>
      ...
      <thead>
      <tr>
      <th class="acreditacion" scope="col" colspan=2> **Coparticipación técnica y/o académica y/o
      financiera
      ...
      <thead>
      <tr>
      <th class="acreditacion" colspan=5> 3.19 Participación en cuerpos colegiados</th>
      <th></th>
      <th></th>
      ...
      <td><input type="value" id="cantCGUpermanente" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalCGUpermanente"></td>
      <td><input type="value" id="comCGUpermanente" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantCAACintegCom" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      ...
      <td><input type="value" id="cantComDepart" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalComDepart"></td>
      <td><input type="value" id="comComDepart" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantComPEDPD" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalComPEDPD"></td>
      <td><input type="value" id="comComPEDPD" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantRespPos" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalRespPos"></td>
      <td><input type="value" id="comRespPos" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantRespProd" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalRespProd"></td>
      <td><input type="value" id="comRespProd" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantRespLab" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalRespLab"></td>
      <td><input type="value" id="comRespLab" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantExamProf" placeholder="0" oninput="onActv3SubTotal3_19()"></td>
      <td></td>
      <td id="subtotalExamProf"></td>
      <td><input type="value" id="comExamProf" placeholder="0" oninput="onActv3Comision3_19()"></td>
      ...
      <td><input type="value" id="cantExamAcademicos" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalExamAcademicos"></td>
      <td><input type="value" id="comExamAcademicos" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPformResp" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPformResp"></td>
      <td><input type="value" id="comPRODEPformResp" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPformInteg" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPformInteg"></td>
      <td><input type="value" id="comPRODEPformInteg" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPenconsResp" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPenconsResp"></td>
      <td><input type="value" id="comPRODEPenconsResp" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPenconsInteg" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPenconsInteg"></td>
      <td><input type="value" id="comPRODEPenconsInteg" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPconsResp" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPconsResp"></td>
      <td><input type="value" id="comPRODEPconsResp" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
      ...
      <td><input type="value" id="cantPRODEPconsInteg" placeholder="0" oninput="onActv3SubTotal3_19()">
      </td>
      <td></td>
      <td id="subtotalPRODEPconsInteg"></td>
      <td><input type="value" id="comPRODEPconsInteg" placeholder="0" oninput="onActv3Comision3_19()">
      </td>
  ...
  <script>
    ...
    function onChange() {
      ...
      document.getElementById("hours").innerText = minimo;
      console.log(minimo);
    ...
    document.querySelector('form').addEventListener('submit', function (event) {
      ...
      storeResponses(); // Llama a la función para enviar los datos
    });

    // Llama a la función para actualizar el objeto data cada vez que haya un cambio en el formulario
    document.querySelectorAll('input, select, textarea').forEach(input => {
      input.addEventListener('input', actualizarData);
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function submitForm(url, formId) {
        ...
        switch (formId) {
          ...
          case 'form2_2':
            formData['hours'] = form.querySelector('input[id="hours"]').value;
            formData['actv2Comision'] = form.querySelector('input[id="actv2Comision"]').value;
            formData['obs2'] = form.querySelector('input[id="obs2"]').value;
            formData['obs2_2'] = form.querySelector('input[id="obs2_2"]').value;
            break;
