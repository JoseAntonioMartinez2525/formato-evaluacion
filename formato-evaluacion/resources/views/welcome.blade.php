  ...
  <div class="bg-gray-50 text-black/50">
    <div class="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
        ...
        <form id="form1" class="form-container" method="POST" action="{{ route('store') }}">
      ...
      <main class="container">
        ...
        <table class="table table-sm">
          ...
          <tr>
            ...
            <td class="horasActv2">4</td>
            <td id="puntajeEvaluar" class="puntajeEvaluar text-white">25</td>
            <td id="comision1" class="table-header comision">12</td>
            <td><input id="obs1" class="table-header" type="text"></input></td>
          </tr>
          </tbody>
        </table>
        <table>
        ...
        <div>
          ...
          <table>
            ...
            <tr>
              ...
              <th class="descripcion"><b>CAAC, Instancia que la otorga</b>
            </tr>
            </thead>
          </table>
        ...
        <td><input type=" value" id="comNCAA" placeholder="0" oninput="onActv3Comision3_5()"></td>
          ...
          <tbody>
            ...
            <td><input type="value" id="comisionInicioFinancimientoExt" placeholder="0"
              oninput="onActv3Comision3_13()"></td>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function submitForm(formId) {
        ...
        switch (formId) {
          ...
          case 'form2':
            formData['puntajeEvaluar'] = form.querySelector('input[id="puntajeEvaluar"]').value;
            formData['comision1'] = form.querySelector('input[id="comision1"]').value;
